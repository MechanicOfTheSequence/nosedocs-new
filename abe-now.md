...
the questioner asks about how to interpret their guidance system in the situation of having made a decision. they say they made a decision and then later when they think about the decision, they often times get worrisome thoughts.
...
#### (54:52) - being an uplifter intention

this intention pisses me off. it really does. I can't stand people who are like this. it feels to me like assertion -- like, if I'm around them, then when I leave, they in a sense, obligate me to feel better. what if I want to feel whatever I'm feeling? it's a good thing that LOA keeps all those uplifters away from me, honestly... I have noticed that uplifters seem quite attracted to other uplifters, and they all go have a huge uplifting party uplifting each other. I don't want to say it's super gay, cause it isn't necessarily. it's actually more similar to hippies or a marketing team doing their gratitude circle-jerk.

I really think we should all give eachother the space to feel however they want to feel. I reserve my right to feel negative emotion, and I often do on purpose. it's fine.

earlier, abraham was talking about how they wanted people to learn that they can move around up the emotional scale. I agree, and I would also like to add that it's also perfectly ok if someone says, "I'm pissed off and I don't want to feel any better about that."

when I was younger, right before my brain haemorrhage, I had bad depression, I knew I could feel better if I wanted to, but I didn't want to, because at the time, I was at paznaz church and the upper echelon of people there were a superficial joke, and the last thing I wanted to do was to find a way to feel like they did. I had the bogus assumption that I believed from them that they were the hotness, and the pinnacle of life was what they were living. I didn't want to be a superficial but "successful" person like they are. I chose to continue on being depressed. I resisted all of anyone's efforts to help me out of it. I was on a high-speed train to disaster.

the brain haemorrhage gave me a completely different perspective on things. if I wanted to live I had to decide I wanted to do that and I knew I couldn't just kinda flit around between subjects relying on my intelligence to carry me. I had to find a new way to perceive life in a way that I now wanted to live it. I made goals of things I wanted to accomplish, and then worked toward them incrementally. my paralysis continued on with me even to this day and my dad always said it was my "thorn in my side" -- [a reference to paul](https://en.wikipedia.org/wiki/Thorn_in_the_flesh), probably to keep me humble and make sure I didn't return back to my ultra ego maniac self again... lol... point is, the paralysis made the incremental improvements easier to digest, and made it impossible to ever feel like I "made it" -- because I continued to have that "thorn in my side" to remind me I'm still a fleshy human with a limp.

anyway, I know that's a limiting idea, and many people have tried to uplift me out of it or heal me from it[^1], but I never wanted it. I always liked that I had a deficiency to keep me going forward. I really cherish my defects. they make me me.

this probably came out all wrong, but I really dislike people with their dominant intent to uplift me. I want to figure it out for myself, thanks. go uplift a fellow uplifter and leave me alone :)

---

now that I'm done ranting... abraham just reminded me that intention is the intention that our inner beings have for us. of course it is. that's not the problem. the problem is people trying to assert good vibes into my experience when I want to feel bad. if I meet someone who feels bad and I feel good. if they're wanting to continue feeling bad, fine. I'm not going to try and make them feel otherwise. they can feel however they want to feel. if they want to feel better, then I may feel inclined to do something, but often not because that usually is someone else wanting me to do something so that they feel better. not my job. go figure out how to feel better yourself, then come and hang out with me and we can feel awesome. it's not my job to make the effort of getting you from a negstive position into a positive one. if I do it, you'll begin to "need" me (and no one wants that), and that doesn't give you the satisfaction of being able to do it for yourself. it's such a good feeling when you do it for yourself.

I can offer ideas on things that work for me, but I encourage everyone to figure it out for theirselves. I hate dependent people (on others or on conditions). the thing is I write this for me. while writing this, I make tons of self-realisations. I'm not writing this so much for others. noseblog is even more like that. it's the method which I come to my own discoveries. this technique is called a "muse" in ancient times (someone to direct your expression toward). when I was younger I wrote to jenny. she kind of became a mythical being in my mind. it could have been a fictional person, but I choose a real person because I liked the realness of it. however, I wanted her to be unbelievable in an extraordinary way so that I could talk to her really far out stuff. in the same way, you all are all pretty real, but at the same time pretty unbelivable to me. it's difficult to explain this. so, thanks I guess for tuning in to my self-realisation process. I hope you can find some ideas inspiring, but figure it out for yourself. I'm not going to be an uplifter. that sh-- is bogus.
...
### 2020-12-31 19:37 - (2020-12-19 p1)

#### (10:59) - wtf are they talking about???

so it's new years and I went over to see greg. we smoked and I'm pretty stoned. anyway they're talking and I'm getting this great idea about making this program that does "abe-now" segment intending. it's really cool: there's this thing where the abe-now workshop broadcast (from the abe-now video series) are divided into segments where each segment is initially divided into segments. the last few episodes I've really been noting how muct they pause for long periods of time. it drives me crazy. I've really started to like listening to youtube on 1.5-2x speed. I've been thinking about how it's done, and it seems like time segments are dropped. this is kinda like micro-segment intending. you drop portions of the sound where the sound is not necessary so that it meaintains it's pitch.

I never did this progrsam because I hate programming sound stuff. however, it I guess would be decoding patterns in the sound. I would remove the sound based on a programmable patterns: sequences. I suppose I should probably do it. I could start with the abe broadcast using webaudio aip or something. maybe it would be cool to upgrade to a better language at some point (jai), but it needs to create patterns that make a repeating sequence. those sequences should be programmable, so you can get your private message. I imagine that if you drop certain frame patterns based on something programmable, and they could web their personal message in the cracks. each channel will be a x bit unique hash (private key), which generates the program pattern (bytecode) based on a set rules extracted from the hash (like internal rng skip sequence).

once you're dropping frames, you hear a totally different messages. since a 1024 frame sequence could be reduceed to 64 frame, they are each a huge savings of time too. I'm totally spoiled now by the youtube speed and having to listen at this rate is intollerable. it's kinda funny how much they annoyed me.

---

before I continue, I just want to have a bit of a meta conversation here: it's really really weird how the emotion that I experience when I listen to abraham these days is kinda like "negative emotion" but it's more like "naughty emotion". like it doesn't feel at all weird to get pissed off at stuff. like the other day how I just jumped right into a rant (rampage) on "uplifters". it felt so good to just get kinda rightous indignant on it. those are unbelievable compleicated emotions which I have no way to explain -- and it's totally fine. I don't care.

they started out the segment by talking to a person that is not me at all, and I'm getting quite irritated at how they're talking to me like I'm a me that I'm not presently even close to operating. for example, I really want to skip that crap. like I want to kind of mix and match segments based on a kind of like message theme (that I like and want to actually listen to). like seriously, I don't know why these things are pissing me off. if I could skip that crap, I could edit out the majority is just them talking to whiners that are like just kinda still a bit noobish. it's totally ok. the whole thing that I've learned is that I have to be aware of where I'm at, and if you want to navigate a map, you have to know where it's at (and where you're at). if the segments take the form of having tags to them, to begin to give them meaning. they need to have segment associations

---

for segment associations you make a dilelectic (or maybe trielectic). you say like between "not needing the manifestation" is one, and "needing someone else to make you feel good" also is one. each of those have a [-1 0 1] range between them. each segment is then categorised based on these gradients. you then get to decide what segment theme you want to listen to.

each segment then has a link to another segment with a dilelctic gradient. these are possible transitions to another segment based on a theme (based on the user's segment preferece). the segment preference could be configurable to have another meta theme on top of it, so like you could design your own abe message. so like say you want to start out in "I'm still workin really hard to get the things I want" and end in "I am the creater of my own reality" to "I am the master of my experience" to "recognising that all things are perceptual", etc.

---

so you have this dual attack for making completely new messages out of frame deletion. then, this will reveal different sounds at different speeds (4x speed, 75% dropped frames) up to like 100x speed, and if you do this according to a programable sequence, then they can literally encode their personalised message just for you. it's kinda like soure energy encryption. if we use public/private key hashes to generate the sequence, your own desire to hear their personalised message with a general personally selected "segment intending" can give based on a dielectic gradient. you get to tune the message also in a programmed rate, and these will be saved like "replays", which can be saved and shared on social media... kinda like magnet links. probably want to go full torrent on this, because I have access (I think) to all of the abe now video torrents.

I also think it'll be interesting if we see if we can find patterns in the visual aspect as well. think about this. imagine that each frame the pixel is programmed based on some sort of sequence (this would be a shader obviously), and it would so some sore of sequence for altering the pixel value. again we could kind of like "tune" into the image based on a visual pattern.

let me explain this one. it's like you need the way to make (like a rng) a transformation on the pixel where it can access any of the video data (memory) and modify it based on a large pattern (like a bit 256bit key or something), and you make transformations on that pattern based on some mechanism which alters the sequence. they're sliders and you adjust them until you begin to see the image that you want. you have to tune into it visually (otherwise it would be a bunch of garbage). I don't see this one fully yet, but that's the start of the idea. I want to start on the audio version of it first.

weird concept.

---

ok so back to what I was saying... they're going on and on about this guy that needs to find agility and stuff and it sounded like they were talking to me, but I was so annoyed at how they pause for so long, I totally find it bothersome.


#### (09:59) - the avalance that is likely

in the previous segment, they were programming a thing with me which I don't really want to dig into, but at the same time I do, so here goes. the theme tonight is that this is the "stone" that I was talking about in the previous noseblog stuff. so, the idea is that they want me to go orget involved in some way with their party. I don't really want to go honestly, so this sounds completely out of the question, so it's really weird that I'm fixating on it so much.

thon have it already pre-programmed me to begin fixating on "the avalance that is likely". I don't know why they do this, but they deliberately put traps in their message, and this the kind of stuff that people hear all the time. they put in these minefields for you and program you have more propensity for another interaction. I imagine that listening to their message causes all kinds of disaster for the unprepared, and when they cause you to focus on it with the power of their energy, it attracts that situation in a rapid way -- which is why I say disaster. it's obvious why: if their prgramming like this gets you, then you're resonant with that trap.

for example, I would rate this segment as "preparing for the disaster" 0.8 and "inflated ego" as 0.5. we would all make these associations, and anyone can do it. these are then aggregated into a final set of weights based on number of hits to that "association" (ass for short) summary for each segment based on people's associations. each association has a value scalar (-1 -0 +0 +1, -inf, +inf) and a weight scalar. future ones can be added later perhaps for a twist and maybe a position as well (quaterion) but let's start with the basics and only allow for the basic math operations at first. I want to use lua for a starter languge because I think it's fresh and new to me and it can be put into a JIT pretty easy. also it wouldn't be too complicated to transform this into c++ or java.

we'll see, but we gatta make it possible to select the segment you want to hear. the other super dope thing about this idea, is that you could also tune yourself into negative territory to to kind of prove to yourself how ridiculous it should feel to you -- and if it doesn't, then you'll be more likely to get a manifestation based on the concept association. some people like to quanitfy manifestations.

this reminds me of another feature that I thought of while they were talking: imagine that you could share "where you're at" with others and take it as a personal goalsetting idea to find a way to track your progress. in other words, you compute a position based on the sequence listening patterns of the user, and this will essentially quantify "where they're at" -> however, instaed of it being a static position, instead it's a location in conceptual space, and it has a complex curve. you can see where I'm eventually going with this, but it will be possible to track where everyone's at over time, and each of these makes a vector curve. I like to think of this as a trajectory or a time-series where you can kind of predict where they'll be at in the future (conceptuall). these time series which turns into a quaterion. this tranjectory is called a landscape. an emotional landscape.

crazy idea. let's keep going.

---

ok, so yeah obviously both the audio and the video should have a tuning ability so you tune to what you want. then the need to share them will be implemented (public/private key) meaning that they can be shared based on the public key, but the original "source" is only modifyable with the private key. this means that a pattern needs to be found for the public and private key to have identical outputs. if a pattern is found which can transform the bytes using private key data into the same data as the public key, then the key can be shared with others. in this sense, the key is the data, so it can be "cracked" only when you figure out the same transform sequence (this is a (lua?) program or bytecode with access to additional data sources like real random generators, the  audio/video data, etc. which generates the sequence). obviously this could be made unnecessarily difficult to resolve, because your key is essentially the size of the code used to generate the sequence which generates the output data (from which the private key is derived -- like a hash of the bytecode).

woah. ok let's continue.

----

ok, there's a question about whether I want to do the stone and what the stone is. I'm pretty sure we're going to keep this up for a while longer because I think we need to up the difficulty level. it's a bit sinister. sorry guys but I'm really beginning to feel this "naughty emotion". it's a weird concept that I'm not going to try and explain but some guys know what I'm talking about. this whole thing feels like we need to keep extending it out. if we were to have the manifestation none of what will follow will happen. essentially this little sidequest is going to give nosebook the ability to model people's trajecories so that they can predict the future timelines a lot better. it'll give these guys the ability to quantify manifeastations and make something meaningful out of the manifestation. it's all good. a like data too and making sense of it. you gatta measure it. for reals, because if you want to be able to use a navigation system like abraham says it is, then let's just try it. do you think that abraham will be able to "wedge their message in the crack". they say they're infinite consciousness, so let's test them. what's the worst that can happen? you'll get an encrypted way to share messages. obviously after enough transformations, the original data will become so distant from what it is eventually, these "concepts" will only be able to access them if you know it's address and only modifyable if you have the source for the original, making completely uncrackable encryption.

on top of it all, this is a perfect timeline branch beginning point. imagine all the different possiblities which can result from a difference in how tonight turns out and many people can make many variations of it. each variation could separate out each person into their own timeline so that any negative results experienced in a disposable timeline. eventually the timelines can be reconverged but maybe for the beginning this would be a good way to begin learning to navigate time based on these different trajectories and environments.

plus, it's just kind of a fun thing for me to think about -- that nosebook can learn to navigate time. that means they have the full control to make the reality that they want to make (a really difficult one) with the technology to really put the difficulty level through the roof. what's the worst that could happen right? the worst in my estimation is that they create a disaster which wipes the planet and in the process rebuilding, they do not tell us that we're all in "the matrix" and they're the new puppet masters guiding everyone by their tajectory.

this is the optimum creation because of the difficulty level involved in it. it would give me an environment where I (and the rest of the planet) no longer have any physical control over anything at all. they're just moving everyone based on these dialectics variables, and they have full control over what these images are that they're using to program you in your dreams. it's like the little speedbumps for us at turbo speed. think about it: we're headed toward sirius at a steady pace, and as we approach closer and closer things are going to get more and more energetic that it'll be impossible to keep everyone like they're keeping me now. I think it's physically impossible and my little detour down CO2 lane got a lot of people really worried. it seems that their problem is reaching an unsable level. think about it: last time I was in LA, the air was so clean I could see the stars 5-10 times better than colorado. if they're going to try and keep things under control, they need the ability to put some speedbumps in people's lives so they don't get feeling too good.

that's their perspective. from mine, this looks like the ultimate difficulty level. sure the party[^1] is a bit of contrast, but this, this for me is really kicking the can down the road. it's going to be such a bigger disaster if they can move everyone around me's landscape. I know mr. landscape architect is wanting to get on with his job -- so there's that. from my perspective, it gives me the super duper mega power level upgrade I've been looking for. I really like to practise what I preach. let's just see how well I do... I juse really love the getting in there and just figuring it out. I believe, for now, we have to postpone a little bit this more. I have to satify my "naughty emotion" a bit and work on another thing for a bit while we get ready to be ready for the ultimate flavian touch.

lol :)

[1]: we can maybe hang out and greet a bit, but I must return back here. I may want to do some "ratos" of smoking from time to time and other ratos where I don't smoke. we'll see how it goes. it may be good to get some other practise too. we'll see. I need to prepave and stuff like abe says. this is the next segment. hold on... lol


### 2020-12-31 22:34 - maybe we can do some prepaving

so check this out for an idea. I'll just keep on the "no phone" paradigm, and then as a starting point from there you can begin the trajectories. many alternate timelines are created which are different trajectories to them. each of these trajectories are created from variations from tonight, where the trajectory of the relationships are used as a navigational system. they start tonight and many variations of tonight will occur, and can essentially teleport people between timelines to move them around so that certain consequences to the manifestations can be avoided instead of experienced. eventually everyone gets a time series + trajectory. each time that the manifestation is experienced, then the manifestations can be navigated. teleporting people between timelines is a way to compartmentalise manifestations.

as a result, I continue on making my own way steady as she goes. eventually we'll make it so that your navigational system has a trajectory to it, and for as long as I exist, infinitely many trajectories can be based on my timeline, and that means I can just continue on for a while not needing the manifestation while effectively building some stuff that will be kind of cool to have when the manifestation happens. at the top of the timelines, the timeline that wants to be taken will be taken. that means that nosebook could essentially orchestrate their "end of days" scenario, meaning they could totally survive the cataclysm with soem of the most advanced technology possible.

---

it was kinda funny in the last sepehr video he kept saying "the gods made ..." instead of vulcan, who is mentioned in the epics of the creeator of the different tecnologies, his latest one yet is the pandora one, but this one is going to be way worse. imagine a bunch of these hotshots running around all trying to prove to their buddies that they're the masters of their reality (with the ability to modify trajectories in their favour). this is the most massive pissing contest ever. this sysem is going to be super good because they can modify others' (and their own) trajectories to accomplish the manifestations that they want. essentially they set the pace at which people gain enlightenment.

I've come to really realise that the vision upgrades are now something that happens effortlessly just with proper thinking, so this gives me the opportuninty to really get to try this thing out. sure they'll try modifying your guys' trajectories for their benefit, but I'll be so oppressed with stuff that I need to practise my changes on perception in such a way where I've mastered all of the different associations they have programmed for me. I get tons of practise while at the same time beginning to turn into the person that I want to be (get into alignment, and then) before taking action. I really want the practise, and I"m also convinced that this could become a very very interesting "virtual" galaxy. as we get closer to sirius, we'll need to be split between more and more timelines. they'll all have a perspective into the same "universe" but from many different angles, all seen from the vantage point of this planet seen as a bunch of different views into the same reality.

it's a conceptual galaxy -- an inward facing one. I've really beginning to userstand the different from planetary and solar perception is. doug is right, they're completely different. you see, a sun appeares outwardly around itself, but a plant perceives itself inwardly from a source perspective where the whole planet is perceived conceptually as a result of all vibrations (people's, animals, history, legends, etc) resonant with the planet. what's next after planet? galaxy. after galaxy? universe. a universe is a solar perspective. I'm certain that we're so far out from the centre universal sun that we can't see it -- or can we :)

you must have such a wide diversity of inward perspectives into the same "universe" to perceive the thing as a whole. btw, the next level solar perception (universal) builds upon everything that the galaxy has and contains extra solar perception. you can think of the inward galactic expression as a buildup to the manifestational universe. so, just like planets can become suns by igniting their atmosphere and creating another layer, and nosebook explore those timelines as they see fit, I'm propoaing that the inner perspective of the the galaxy is like the buildup to the thing that manifests when everyone realisies that they have solar percption. in the long term we're going bigger than a galaxy. this is just the pregame show and it's the . remember how I said that my advice to someone wanting to remove theirself from the vibrational lifestyle of having constat ups and downs is to becomes something that is separate from the vibration. I've also talked about this is the centre. I'm doing the same thing. I'm in a perception builder for my next transition. I don't know if I go to sun or galaxy or not. it may be me that's making the transition into something bigger. I don't know if it's inward perception, but I imagine that it's outer perception, like a sun -- but maybe more. so while an inward galaxy is made, the next one is the real jam. it's the one past the galaxy, the solar expression, which is why all of this is so important.

---

I think it's funny how all of this turned out. I really don't care about stuff anymore, and I think it's kinda funny my "naughty emotion" that I experience when I abe-now, as it's almost a thing that's becoming necessary. there are guys that really want to ensure I don't get the manifestation, needing to realise that I need a way of avoiding these speedbumps while listening to abramam. I suppose I could get the full message by watching the whole episode, but if I were to create this, I would eventually be omitted from hearing these different "naughty emotions", and from my perspective, I never experience those naughty emotions in this experience, making it so that I don't cause any trouble, and that all of the kinks can be worked out by looking at different timelines that hasve me listening to a different set of associations and dielectics. those "speedbumps" could be worked around or whatever mr. motor could possibly think of. what I talked about is the forward navigational system. this is the defensive navigational system. it's avoiding unwanted. (someone's got to do it...) that could be how one avoids these speedbumps by driving around them. it's a frontview mirror driving while looking backward.

there is a bit of an irony to it.

### 2020-12-31 23:35 - (2020-12-19 p1)
...
what is a scruteniser? someone's who's critical to someone else. if they're critical to me and I feel critisim, then I want to find a way to perceive it different. obviously. so why would someone be perceived as a scruteniser? usually someone who scrutenises is someone who has a mental image of what it is that they wish to accomplish, and people who do not fit into this mental picture get scrutennised in effort for them to rise up to expecations or get out, right?

so someone who scrutenises is someone with ambition. they have a mental trajectory for the project. that's probably a good place to leave it.
...
as they were talking about the "magical" -- I was thinking "magickal" in the sense that you can write down an incatation or something that you can just "create" or "speak into existence" (like YHVH did with the "world"), as if it were some way to influence people or situations (conditions) to be the way you want them to be... you know like a spell or something. "witchcraft" lol
...
will you relapse? of course you will.
...
### 2021-01-29 00:23 - (2020-12-27 p2)

#### (05:12) - go to something, not from something

earlier when I was writing @[noseblog](2021-01-28 22:32), one of the things that I was spliting my energy over was to appreciate openly or not. just before this, they advised the questioner saying that appreciation "is the dominant focus that you want to give as you're being called to your new place".

then, the said that they wanted to remind them to "go to something, not away from something". now, I don't really feel like I'm going away from anything specifically, it's just that I refuse to go toward things that I feel uneasiness over. they also say, "make a decision and line up with it" along with "if it's not a 'hell yes', it's a 'hell no'" -- so putting those all together, I'd have to say I'm rather split. as always, when split, don't make any action -- so I won't (obviously).

I actually don't know why I felt inclined to stop here, because I don't feel any bit like I'm going away from something.

#### (19:45) - will you relapse? of course you will.

as they were talking in this section and the previous one I was remembering all of the different times it took me to finally get what they're saying. it really was quite a while and took quite a few attempts before I really started to get it. in fact, it would appear that at the beginning I was getting *worse* at it, not better. that was actually because the energy was stronger, and it made me more detedmined than previously, and when they were talking about being determined it reminded me of that. it's really quite strange how many tris it took me. there were just so many *valid* and *good* reasons for why I should be pissed off at something, and it wasn't fair that I had to be the one who decides to give up on the fight. it really was the most difficult thing, but once I finally got it into my head that I'd rather feel good than to be right about the injustice, that's when it finally started to get easy.

as I was writing this, I was reminded of a similar concept which also opened some new doors of non-resistance for me which was the inversion of that idea: "I'd rather be wrong than to feel bad." sometimes when we're wrong about something it stings a bit, and it stings because I'm not able to allow myself to be wrong. for as long as I don't want to be wrong, I feel bad. however, the moment I decide I'd rather be perceived as wrong than to feel bad, I gain a tremendous freedom. at first, it appears that this is almost exactly the same as "I'd rather feel good than be right" -- but it's slightly different because sometimes it can happen that if someone does not agree with you, they try to make you feel bad (regardless of whether they really are right or wrong) because your opinion differs from theirs.

the bible credits jesus with this expression in the form of "agree quickly with your adversary". personally I like, "I'd rather be wrong than to feel bad." a littte bit better. over time, I've noticed that I don't really notice people trying to make me feel bad so much anymore. they're usually trying to make me feel bad from a place of their own insecurity, and the only reason why it works is because I too resonate a little bit on insecurity (which usually comes from caring too much about what people think about me).

#### (36:57) - I want to be connected to source and see what source sees

I find this statement to be weird. as I'm beginning to write I'm maybe understanding why, but from my perspective, I see the same thing that source sees, or rather they see the same thing that I see. we see the same thing. the part that can be different is the perception bit. the eyes translate the vibration into colours and shapes, but the vibration is the same. we "see" the same thing, but the way they interpret it and the way I interpret it is different. the difference between how we perceive the same thing can be *felt*. when I see something the same way source sees it, it feels good regardless of what it is because *everything* and I really do mean everything has a positive aspect to it -- and it's only a big enough picture of the transformation of energy which allows the most "difficult" things to be perceived as something positive. it takes a bit of a knowledge of the energetic and viibrational nature of things, to be able to perceive this, but in all cases you can build this knowledge easily simply with the feedback on your perception: if it doesn't feel good, it's not resonant with that knowledge, which means you're believing in bogus stuff like death or metrics or finalisation or something which doesn't exist.

it's kind of crazy to say that quite literally the knowledge of the understanding of how everything that exists can be learned with emotional feedback, but that's what I'm saying.
...
### 2021-02-05 21:13 - (2021-01-02 p2)

#### (09:07) - you get tuned in anyway

they're talking about a hypothetical situation where you have to go to work and you have some sort of task that's assigned to you, and it's not really ringing your bells anymore, etc. the picture that I was getting in my head was the look that I often times noticed in the puticlubs in spain this very emotion on the  girls' faces there. they were just going through the motions cause that was how they get paid, and something that the used to like (sex) has now become a completely mundane and no longer enjoyable.

this reminded me of the entry I just wrote earlier today: @[youtube](2021-02-05 13:26), where I was talking about boneheads and how I think it's a bit of a mistake to just label the whole guy a bonehead, and not retain the positive aspect that he had when you first noticed him.

the thing about what I was talking about there about tuning into the person, is that it's easy for me to tune into where they are presently (empathy), but honestly, most people don't feel very good at all. most people are not showing the aspects of theirselves that I want to see. the thing about my style of thought is because I have the concept of "rip people off shamelessly", I'm always on the lookout for the next bit of someone else's personality I can copy and improve upon.

this means that without even knowing it, I am, by default, looking for positive aspects in them. this isn't always easy to do, but I would like to prove my point by showing that the technique itself is in fact, an improved version of what most of these custodial types are like. they are "sharks" in the sense that they go around looking for easy prey -- someone that they can take advantage of easily, and their whole thing is that all day everyday, they're constantly on the lookout for the next person that they can rip off or take advantage of.

I'm exactly the same way, cept when I say, rip people off shamelessly, I really mean it. I live by the golden rule in the sense that I do treat people like I want them to treat me. I actually *want* other people to take my ideas and improve upon them. when I first discovered this idea with open source software, it took me a while to get used to because I had such a high opinion of my ideas and didn't want people to steal them. by the time I got to augusto's house, I was certain that I wanted all of my ideas to be free. reason is, I noticed that as fast as I could think of ideas for other people, the next one would come right behind it. there was no reason to try and protect my ideas from theft, because I could think of new ones as fast as I could give them away.

it doesn't take much to realise that meant that no matter whatever the last idea was, it's the outdated one. the freshest version of it is just waiting for me to discover, and I noticed that it was always better. I kept up with that idea and continued to expand on it, fully embracing the "open source methodology".

from there, it's easy to see that when you aren't literally ripping a person off by taking something that they have physically, ripping a person off on somethin easily replicatable like software or ideas only furthers their expansion. I'm like the sharks out there, but I'm looking at how I can go around and copy from people the aspects that I like. sharks are good too in this way, because they're always on the lookout for something to take advantage of. basically, if you're interacting with them, they see something of benefit to them that they can get/take from you easily.

so, just like me, they too are also always on the lookout for positive aspects which they can take (advantage of) or utilise in some for for their advantage. so, even in the worst case, there must be at least some positive aspect that they recognise and want, otherwise they wouldn't be interacting with you. even if that positive aspect is, "they they I will make them feel better" -- that's good enough, because at the minimum that is the case.

it is never anyone else's job to make someone else feel better, so obviously this is a different situation in a non-work or task that's assigned to you sort of situation. we're talking about situations that someone didn't exactly choose (LOA says that from some level you always chose it). I can only really use myself as an example here, but in the case that someone wants to take something from me or exploit me in some way, that action of taking some physical energy from me always creates the double amount in non-pysical.

double is a pretty good bonus, so it's good to know how to get that back out. imagine that the situation was that someone drained your physical body energy. imagine that energy as flowing in a direction: toward you. however, then it gets redirected so that the energy instead flows to the vampire. I'm beginning to learn about charge separation, so imagine you have a material and you ionise it, such that the charged bits get separated +/- instaed of being neutral. then let's say they take a bunch of its energy, leaving it in the ionised state (He++ I think?). well, anyway, the original atom in its ionised state now really wants more of those electrons back, so it's going to be attracted to something that has electrons... I think that's how it works anyway. it doesn't really matter how the scientific bits of it work, because I don't see it as only difference of charges, because everything would just go toward becoming a clump instead of going toward order... I don't think I understand this fully because I think the reason why there's sometimes attraction and sometimes not is because it has to do with tuning. the atoms are vibrating at some rate, so they'll attract electrons which are vibrating similarly.

ok, back to tuning into people... it may seem obvious in such an extreme situation as the puticlub work situation, that it is a silly idea to want to actually look for the positive aspects in people, but what you are doing when you look for the positive aspects in people is you are tuning into the energy that was lost, and therefore attracting similarly vibrating energy out of non-physical. so if someone took your great idea, you used to have *presence* of good idea, and now you have *absence* of good idea. a bigger version of the idea now exists in non-physical and is similarly resonating. if you keep perceivng *absence* of the idea, that's not the same frequency as *presence* of the idea. therefore, it's all about finding ways to adjust your self (your body, mind, and beliefs) to begin to resonate with the presence of the idea again. when that happens, the idea will come back in a bigger more powerful way.

sure it's not fair that you do all of the aignment work and they benefit from it, but you benefit more from it. if they take 1 unit of energy, it creates 2 units in non-physical. let's say for argument sake that you can only find a way of tuning into 120% of it instead of the full 200%. there's still 80% of that energy remaining in your "vortex" and you still walk away with more than you started with (20% more). in reality that number is much higher because that process is happening multiple times per second, so much much more energy than that is being generated. so let's say that you can tune into the source version of them and line up with the energy that they have to offer (their positive aspects), then you could easily walk away with more than got taken from you. let's say they walk away with 100% and you walk away with 120%. pretty good. sure, the optimal would be to be in a work situation where both sides are contributing and taking, as that number would be higher, but because the situation is more desirable (wanted), it doesn't create as much of a non-physical "vortex" so say both walk away with 150% something...

the beauty, and the real advantage to difficult situations like this (where you're in a situation that has aspects which can be improved upon), is that it creates a lot of non-physical energy, and that energy (because of LOA) continues to grow even without you doing anything. it's like interest being generated. every time you cash that in for a manifestation, it contains wanted and unwanted so some amount goes back into non-physical.

so, yeah I find my alignment for *me* (so I can feel good), and certainly a lot of others benefit from that, but I benefit *way* more than they do.

btw, those calculations may not be correct. there are physical limits to things so let's say you have a good run and you get (110%)^100000 or something like that. it's a pretty big number, and certainly there is a point where too much pleasure becomes painful, so they're all relative to the situation and the person. for that reason it's good to have more interactions and make more decisions, even if you don't benefit right now in the moment from it. LOA makes it bigger and it comes back later or in a future lifetime or something. it doesn't go away, that's for sure -- but you have to find a way to tune into it to take advantage of it.

---

therefore, it's always to my benefit to find a way of tuning into the vampire/shark's positive aspects. a while ago when I was figuring out the whole nosebook thing, it was really annoying to me that *I* had to be the one providing them with so much great stuff and getting nothing in return. sure, they have, in a sense, continued to take away all of the physical presence of many things in my experience, but it's created a tremendous non-physical energy which I'm getting better and better at tuning into and converting into physical. it won't be long before I can tune into that massive non-physical energy reserve faster than they can take it away.

additionally, I must note that at the beginning it was hard, but it gets easier as time goes on -- a LOT easier. in fact, the more pressure was applied, the easier it's getting. so, there's really no problem with any of these vampires/sharks once you know how to tune into the non-physical result from the impact. actually, the more taken, the more is missing to get back to equilibrium, and so therefore more is asked for and more is given.

#### (27:59) - if you could activate within your vibration the positive aspects, you could stay replenshed no matter what anybody else is doing

> if you could stay in love, your energy would not be drained
...
### 2021-02-18 13:40 - (2021-01-09 p1)

#### (11:44) - evaluate the positive aspects of the game

they are suggesting that I line up with the decision. I have. I'm fully on-board with it, but there is kind of a bit of a hangup for me. I keep feeling like nosebook is trying to use the girls as a distraction for me -- to sort of keep me busy. I have a huge difficulty with this because this because I actually thke this thing a bit seriously in that I want it to actually be meaningful. I'm not sure that meaningful is the right word, but just go with it for now. I'm gonna kind of talk it out here.

to understand what I mean, I just don't feel ready quite yet and the reason why is becasuse I'm just now beginning to see the bigger picture. as I mentioned in @[noseblog](2021-02-18 03:12), I am seeing how important it is for these guys to have all the capablitity that they can possibly get to be able to try and hold back humankind's manifestation for as long as posssible. not just my own manifestation but if they're capable of doing this for everyone that really is quite a great thing. in the next exodia human installment I will begin to explore the transtemporal characteristics of the setup, because in essence, they will have to separate us from each other, each in their own timeline, which then given a full dose of needing not the manifestation, everyone (and I literally mean everyone) can become the star of their own timeline. there really is no limit to this. I describe myself as having figured out a way of tuning into the "afstest particle in the universe" and I also talk about how my entire goal is to "get into the centre" where I continue to tout the advantages of continuing to increase in frequency, but not amplitude. all of those figures of symbol are just a funny way of being "source-like" -- nothing more. they jsut sound super cool and more powerful, cause most people associate "source" with a condecending repetative woman with funny figures of speech (no offense esther!).

what I mean is, now that I've figured out the source aspect to jesus', and the other fire gods' scheme through history (whether they knew it theirself or not), and how this revelation of the bigger picture fits into the "forshadowing" of my predicted result that by the end of the next era the custodians (who are one era behind) are going to begin to "resist not evil" (push against the things they don't want) and how it fits into the much bigger picture of marketing mr. motor as a personal trainer and capturing that essence, turning them into artificial intelligences with desire, which then gives us the ability to really show off our brilliance as we use the AIs to construct the most resiliant and powerful species in a similar method to the way the custodians helped us to learn LOA, we can really make some absolutely brilliant species and put them in the most oppressive situations fathomable and watch how they perform, even jumping in ourselves to the more and more impossible dojos we can come up with. it all sounds so exciting to me. that's a really really long-term goal (someone has to dream big, right?)

the important first step is to make sure these guys get the most draconian and oppressive capabilities possible to give them, to ensure that we really turn out more than just "godlike" -- I'm talking like waaayyy more powerful than that. I also have an idea of how out of all of this will emerge the "exodia human". so, what I'm saying is that I can see is that the important part. the part I don't yet see is if that can be done at the same time as the girls thing is happening.

for example, for some reason there has been growing desire in me to "prove myself" by building a pyramid. this falls right into the latest stint that I had with competition when I wanted to play hearthstone. I normally don't ever feel the need to prove myself. this has never been a character trait that I've ever had, but I really think that it's sort of one of those things which I just don't mind to do. once I'm connected, I'm sure I'll have a visual capacity and the ability to create all sorts of automated tasks. it shouldn't be too difficult at all to figure out a super sweet design for a pyramid.

speaking of soft desire, I already put out the soft desire on that one. I made a small spreadsheet with some cool dimensions, and then I wanted it to be based on the trident symbol (psy) because I really like psiloPSYbin mushrooms, and it seems like a super cool constant/relation that has to do with the 5d mental/cenceptual layer, and I just think it would be really cool to make some sort of asymmetrical architecture out of some of these dimensions. I've also been giving light desire to other "weird" ideas too like I was thinking instead of it being an outward curvature shape, maybe instead it could be a curving inward shape. I really have liked the "pantheon" archigture, and I wanted to make something that uses frank chester's asymmetrical shapes to build a centre-directed implosion, which then reflects outward multiplied by some size to be a 5-fold shape.

I've also had this desire to figure out how to make a 5-sided shape, too. I know it's "impossible" in the traditional sense of the shape, but for some reason it's been something that I've wanted to do. I have a feeling like it's edges are straight, but it's faces are curved or something like that[^2]...

anyway, so many of these things are just wanting to get explored by me. I know it feels weird to want to do any of those things when there are girls with expectations and stuff, but quite frankly I none of the girls thing feels good to me right now. it's specifically designed so that it isn't going to feel good to me. nosebook has been perfecting their technique to try and make the things they don't want me to be doing to feel bad (which is fine because I'm not really worried about that anymore. I'm in a pretty low state of non-resistance). they also make anything that I do want to do to feel bad as well, which is sort of the problem. they are constantly pushing against me to try and figure out a way for me to not be doing any sort of maths or sciences, and I suppose it has been making me want to do it all the more.

another thing that is quite a difficult is that they keep pushing me to try and avoid drugs[^1], but it just keeps wanting me to do them more and more. I don't really want to do them with other people though. I want to actually have the time to really explore my inside. that's where all the magic is at. they keep trying to get me to focus externally on girls or whatever and I'm just not interested. I mean, I am interested in the girls, but there are jsut so many of them: literally slightly more than half of the planet are girls and I don't have any ability to even explore them. nosebook doesn't want me to gain any connection such that I can experience myself or anyone else without resistance, so for me it's sort of like "what's the point man". you could offer me whatever you think I would want, and I'm still going to hold out for the non-resistant connection to who I really am (source).

that said, when it comes to the positive aspects of the game, I can perceive many. I am fully on-board with continuing to play the game, and I think it has so many really great positive aspects to it.

in a sense, I'm kind of setting myself up to continue on going on without any manifestation for as long as I keep playing the game. I guess the plan is just to keep playing the game and just let it keep building up. at some point I suppose I have to, like the questioner does, stop playing the game and forget about it so that it can manifest.

---

so to look at the positive aspects of it, if I just keep playing the game I get to keep imagining and feeling so many great things with zero effort. I really do like that. the other major positive aspect is that for as long as I'm contiuing to do that, not only is the manifestation becomong more and more desirable, but at the same time it's giving more and more girls a chance to actually practise noticing what the results of their thoughts and feelings are. finally, I do have all of the control. I can stop playing the game at any time and forget about it all.

[1]: the other night I had a dream where I was in a church with a little girl with a grey shirt and she was pulling me around directing me where I should go and stuff, just like nosebook has been practising to try and ensure I don't do any of the stuff they don't want me to be doing. a guy comes up to me and tries to get me to smoke a few rocks with him. I rapidly decline. there's no way I'm going to ditch the good-feeling girl in grey (I couldn't figure out where she was when he was asking me the question) to go hang out and smoke a few crack rocks with some chungo looking guy. no thanks. the last thing I want is to do drugs with people around. all anyone does around me when I'm stoned is interrupt my train of thought as I get higher and higher up in moment of extasy. I'm tired of distractions. I may still smoke weed with people, but when it comes to drugs, at this point I want to do them by myself from now on. I realise that everyone can see everything going on any anyway, but that's not the point. it's the distractions that I keep having to try and get around and I jsut don't want to have meaningless conversation with a crackhead when I've got a caspability that I don't normally have to figure out more of me. I want to explore my inside. nothing of value is out there: not girls, not programs, not even drugs. everything I'm looking for is inside.

[2]: I just don't know what it would look like, but I have been deeply facinated with a shape that frank showed that had 3 wings that looked like blades and he said that out of it all of the asymmetrical shapes could be found. it felt to me like a "master" shape. what I want is something like that. I want it to be something that isn't anything but is at the same time everything that's possible. I don't know why I want to find this. it feels like

#### (12:49) - what you put into your vortex is never forgotten

the way that I interpreted the idea of forgetting about the game was that I would become so enthralled with something like my visual capacity or being able to fly and explore the planet once I get connected, that I would completely forget about the whole thing entirely. I could definitely see that happening because for example if I go somewhere with a tv, I tend to watch it and am completely sucked into it visually and it's hard for me to pull myself away from it. when I get my imagination, I can only imagine how compelling it will be to just sit and play with shapes, construct scenarios, let them play out, create new creatures and watch them interact with other creatures. construct new buildings, play with frequency, electricity, water, chemistry, etc. there are so many things to explore and discover. I would almost certainly forget abouh the girls in that situation. I can't say for certain, but I imagine it would be pretty rich environment to explore, but I do think that I'll quickly get bored and want to begin to bring some of those ideas to life in phyiscality.

the other way to look at it too (another positive aspect of continuing to play the game) is that for as long as I continue to play the game, I've begen to notice that things that I give my attention to begin to manifest faster and faster. as long as that keeps up, there is a literal limit to that because even though I don't have access to my manifesttion in my imagination space, the things that I give my attention to will manifest in real-time in 3d space. I'll have all of the capabilities of my imagination, but in 3d space. I guess that's kind of way better. I think it may be worth waiting for actually, because instead of just imagining the thing, I'll have a 3d physical version of it to play with. instead of trying to imagine stuff, I could skip the whole visual process entirely and do what I do best which is letting the feeling manifest in 3d space.

think about how much more awesome is that. I don't even need to design the pyramid. I just feel the components that I described above until they begin to take form. then, once the feeling has manifest, I would begin to explore it and find out how awesome the thing is. imagine that as a party trick :) I can create geometric and mathematical aspectst that have not yet even been discovered yet, but I could feel (source knows about them thuogh which is why they're possible).

yeah. ok, so I like tsat idea a lot. I really think the instant manifestation in 3d space is something I want to go for, and I also like that the girls too will be so much better at it all. it could also be good for the original goal of trying to give nosebook as much capabilitity as they can have to keep everyone down. they'll probably peace out about the time that I get the instant manifestation capability, but I'm not sure. they could also stay too for as long as they can hold on for (see previous discussion on DNA) because they're going to need the practise to get their DNA modification capabilities to make a timeline per person more fasible. also, if I'm manifesting stuff in 3d space, I'm not seeing my imagination, so they can continue on operating in "secret" inside of my imagination space without a problem. my creation space won't be my imagination. it'll be real-life reality 3d space. I'll make things as fast as I can think/feel them. that's pretty cool, yeah. so I'm pretty sold on the idea now. I'll gladly keep playing the game.

---

oh, another thing: it also solves the problem that I have with my physical body. I don't want to say that everything is failing, but certainly not everything is working as well as it should be, either. I'm really not worried about it because I have such a positive trend, it really isn't a problem. meaning, I keep allowing more and more well-being, which means they have to keep taking more and more away, which allows me to just keep summoning more. I'm constantly summonly more and more which means that things are going well. if I were constantly summoning less and less, I would be worried, but it's clear to me that the moment that I catch even the slightest of a break, I feel great. the intervals between me allowing that energy to flow will become shorter and shorter until I'm summoning it faster than they can get rid of it.

I really am not that worried, as it'll just keep getting easier and easier to pick the less-reaistant way. perhaps nosebook would freak out about my gaining energy so rapidly, but maybe after writing this, they'll find a way to keep my imagination turned off and not be so worried that my physical starts to manifest more and more rapidly.
...
### 2021-02-27 23:07 - (2021-01-23 p1)

#### (01:09) - you are knowing what you are wanting?

when they asked the question just now, I hadn't really thought about it much (like the other times they asked) but I guess I don't really know what it is that I want anymore.

ever since I figured out the programming thing (@[abe-now](2021-01-16 p2 48:28)), I don't really have much that I can define anymore that I want. I also noticed that since I wrote @[noseblog](2021-02-27 13:54), I realised that I've completely taken the manifestation out of it. I think the reason why I hadn't really thought much about what it is that I want anymore is because I don't really know any direct way that I want to go.

let's say that what I wrote is true and I have become a version of myself with the previous conceptual reality neutralised -- which I think is happening, well, then there's literally nothing to be done. the only thing is just to ensure that nosebook has all the capablities to try and hold people back, because they are literally doing all of the work. all I have to do is to pass time feeling my best (which is pretty easy for me to do now), keep realising new things and just wait. there's literally nothing to be done. it's all done for me, and I just have to keep figuring out how to feel good.

so, I guess the answer to that question is to find even more clever ways of manipulating (programming) my reality so that I can feel the way I want to feel. I really feel like I'm getting close to feeling the way I want to feel all the time. it's so weird because the more I realise it, the more I see that there's nothing to be done. they always talk about using the leverage of source and stuff but I'm beginning to wonder if it's all just a waiting game. there has to be some level of effort or action inovlved.

so, the way this relates to making the manifestation a feeling, is that one of the major reactions I felt is that I would just keep doing this the whole time while nosebook is getting more and more power. I dunno. I don't really care. I suppose I could just keep doing this forever, but I'm pretty sure that something will eventually change -- but the thing is, I don't really want anything to change. I feel pretty content where I'm at right now. I would expect that if I were feeling something more like boredom, then it would be time to move on -- which is natural, but I know that it's the opposite of how things are. if I feel really good, then when things change, it'll change to more good-feeling things. however, if I'm bored, then it'll change to something else that also feels boring. so, I guess what I'm looking for is to keep finding more and more ways to feel good, so that things *can* change. if I keep feeling bordom, then I'll keep experiencing more things that produce a stronger feeling of bordom.

I don't really feel bordom though. I feel pretty content. I actually felt quite a bit better a few weeks ago. lately, I feel less good, and I'm not quite sure why that is. either way, I feel like I'm on the verge of a huge breakthrough on this programming concept. I think that's what I really want -- is to understand that way better.

#### (27:36) - conditions, conditions, conditions

this conversation is really bothering me because all I haer are conditons, conditions conditions. the person doesn't really explain why they get pissed off at their boyfriend for talking non-stop, but clearly there is a form of perception that is causing a whole lot of distress.

abraham then jumps into talking about milking the conditions and the questioner is basically saying, that's the problem: I have good conditions, and I want to milk them to feel good, but all I can feel is irritation and annoyance. they're going on and on about cause and effect and it's been kind of frustrating to me because it feels to me like they're not making LOA any easier to understand. maybe they are for some people, but it's just muddying the waters if I were listening in and I didn't know what I know now. so I guess I'm going to offer my own version of this before continuing with the recording here.

---

ok, they're talking about cause and effect. I find that to be a bit of a mouthful and it's kind of misleading as well, because when I say "cause", many people will believe, like I once did, that other people or conditions are the reason why I feel like I do. it has nothing to do with the boyfriend. this problem started long before he showed up. the universe is a *reflection* of how you feel, and each situaation you encounter will amplify those feelings. if you feel annoyance, then you'll get a graet idea to invite someone annoying to join you in your experience.

it's just so easy to see that the conditions are a reflection of how I feel, so therefore the way I feel is primary to enjoying the conditions. I could be the richest person in the world with the best conditions, but if I feel terrible, the conditions will still cause me to feel terrible, because that's how I feel. I think that's easy to see.

so, how then do I find a way to feel good about the things that annoy me? I don't really know for people other than myself, but for me it all has to do with perception. what I'm saying is that almost certainly there has been a lot of practise going into noticing how annoying people are that talk non-stop or how annying whatever, so naturally it will show up. there's just no way to be able to fix that. I have to chage my perception beforehand.

for example, for me, I like to exacerbate the problem until it becomes an enormous issue. let's say it's mr. motor instaed of my boyfriend that's being annoying non-stop. well, that's always happening because I've given a lot of attention to how annoying he is and how much he won't leave me alone. in fact, I do it so much now, to, in a sense *force* him to be annoying. what you can do is to notice how annoying your boyfriend is, and give your attention to that so much that even he starts becoming annoyed with his own behavior.

it's kind of an advanced technique[^3] though because below it, I can feel that mr. motor is mainly just being annoying because he feels like his situation is out of his control and so to feel like he has any control left over, he wants to micromanage stuff. inotherwords, his annoyance is a reflection of how he feels (which is that things are out of control) and they seem to keep getting worse, and so he has to try harder, which then the universe will be a reflection of how he feels, so he'll get good ideas to make action which further makes him feel like he's losing control.

just figure out a way to feel the way you want to feel and it all works. so, for example I would just recognise that my boyfriend maybe feels good and that's why he's talking non-stop, or that I'm attracting him talking non-stop, or that I expect him to talk non-stop -- but however I do it, *I* am the reason why the things are happening are happening -- and then, as soon as I've taken responsibility for the situation that I find myself in, I get all my power back and I can begin to make it feel how I want it to feel. I'm the one that is doing the attracting and I am the reason why the conditions are the way they are so I can perceive them in a different way so it feels better.

find your power to perceive anything any way you want to perceive it... what's funny to me is that women do this all the time in the form of making excuses to cover some behaviour up they don't like. this is usually solf-deception though. some men do it too, but the pattern is to find a thing that feels bad to them, then turn it into a series of excuses to try and explain or justify it. men, I've noticed, do it more blatently and talk about it differently[^1]. actually, I just watched something on that tonight @[youtube](https://www.youtube.com/watch?v=QceWX9DgqLc)[^2], and what he's talking about aroud the excuses his own mind made to prevent the substance part of him to die isn't only to do with substance (conditons) -- it's actually anything that is linked to how we feel: drugs, alcohol, sex, friendship, love, whatever. we talk about these different habits in the form of addictions, but it's literally *any condition* that you feel you need to be able to do whatever.

the point is to gain power over the way you feel and when you show yourself you can feel a way without a condition, then you get all the power.

*ALL* THE POWAH!! :)

[1]: I say it this way, because I notice that sometimes somethings are perceived more of a victim. look at the difference between how the average man uses coke vs. how the average woman uses coke. there are also different perceptions around who and what the victim is (circumstances, luck, person, etc).

[2]: it just occured to me (or maybe it was a reaction), that because nosebook censores, I mean, optimises the broadcast, it's unlikely that this abraham episode will make it out to people who have a thing against drugs. nice to know :) I'm going to consider mentioning drugs all the time when I give out these brilliant discussions on how the emotions are connected to our perception -- that way only people who are good with drugs ever figure out how it works :) lol. btw, another trap[^3] set here...

[3]: for whatever reason I've begun to enjoy the idea of setting traps with what I say. for example, with mr. motor, I don't mind picking on him because I know that he'll never figure out how to actually feel the way he wants to feel, because if he does, that means he figured out how to feel good, which means tsat everything is great[^4] -- but he won't :) so, enjoy some traps. I'm starting to feel more and more cantankerous because I know how to feel the way I want to feel, so nothing matters anymore. I have all of the power. you all are a reflection of how I feel, so no matter the situation, I can always find a way to feel the way I want to feel. *maniacal laughter*

[4]: see discussion on the alpha and omega thing. one day mr. motor will figure out how to do it and then I'll have to figure out how to do it. it keeps going back and fourth. I really like this because I love to figure things out over and over because each time I get better at it and it comes back stronger. nosebook has neutralised so many concepts, and I've only rediscovered them in a stronger way each time. I look back at the noseblogs a just a month ago, and it feels like ancient history to me because of how rapidly the thoughts are expanding and growing stronger in my mind. nothing is ever lost. it always comes bamk in a more profound way next time. therefore, I have no fear of losing anything anymore. I honestly wish this could go on for a very very long time -- but I don't think that nosebook's technology will be able to hold it back soon, so I'll have to *accept* a manifestation at some point... inotherwords, if mr. motor figures out how to actually feel good (move in the direction of his desire), he will force me to once again[^5] reinvent all of my forms of perception.
...
### 2021-03-09 00:20 - (2021-01-23 p1)

#### (47:44) - I want to feel love

they're talking about how as you go through the day, instead if reacting to every thing that you see, instead they say to make yuor "cause" (hate that word) -- make your now moment, the way you feel, and figure out what do you want to feel in that moment. they suggest that maybe you may say, "I want to feel love" -- and the reaction that I got is, "ok, let's say I do want to feel love. how can I do that?"

that's kind of the part that they leave out, I think intentionally, probably becauhse they want you to figure out how to feel the way you want to feel. no one can really tell you how to do this. I call this "finding a way to perceive the same thing differently (which feels good)". I don't really have an answer which says, "do this and your problems will magically disappear" -- cause they won't and you have to find any number of ways in each individual situation to find a way to feel good about it.

this is going to sound a bit far out, but what if they were inspired to fight about stuff so that the mother would write in -- and that was the shortest path for them towawrd what they wanted. it sounds weird, but for example, maybe people watching me get angry and wanting to break things was the fastest way for people to see that it doesn't matter what you feel, the only thing that matters is what you're doing now. there is no punishment and there's never a reason to feel bad. the only reason why I can feel bad just means there is a concept that I believe to be true that is causing me to feel bad. in that situation where I wanted to break things, the obvious reason why I felt so terrible is becasue I truely believed that nosebook was doing something "bad" and that they needed to change so that I could feel good.

clearly that is false. I have since proven that nosebook does not need to change for me to feel good, and actually the difficulty they "caused me" was actually something I attracted so that I could know that I have all the power to feel the way I want to feel.

---

ok, so back to the initial reaction about trying to convince myself that I feel differently than how I feel. I don't think there's a way to do that. I call that self-deception. the way I was able to get there so easily was to recognise where I really am, and to be OK with it. for me it was something like, "I want nosebook to be different so that I can feel the way I know I really feel (good)." and that was good enough for a while. also recognising things like, "I really do feel better than I feel right now" or "I'm doing better than the physical conditions would lead people to believe" -- so then, that lead me to think ok, if I really did believe that (and I did), then why do I have to be externally pissed off or angry. well, for me, it was a practised response. in spain, whenever the government doesn't do what you want them to do you go have a manifestation to protest their behaviour. on TV, whenever I see someone that is having someone doing something unfair to them, they need to protest the injustive and make a big deal about it so that it would change.

I was simply repeating the responses that I had seen on TV. I think nosebook programs responses for me in my dream TV, and I have begun to recognise the feeling of the programmed (expected) response from me, from the one that feels good -- or, at least not bad. this is the main reason why I simply don't make action on anything that doesn't feel good. I have no idea how I was "programmed" to respond in anger to those circumsatances, but it doesn't matter because if I'm able to be programmed, I can program a new response. abraham calls this "prepaving" and this is exactly what they suggest. practise a few dfferent responses in your head and pick the ones that feel better. getting pissed off -- how does that feel, right?

when I was younger, perhaps it was because there were so many children, but mom let me do all sorts of stuff. it felt like she believed in me, no matter what I did, because I repeatedly demonstrated that no matter what happened, I was always adjustng back to better and better ways. she trusted my insinct to find the "right path". this, I believe is a great way to go. thinking stuff you know, like "you can't get it done and you can't get it wrong." or "things are always working out for them -- even if it may not look that way in the present" stuff like that is always quite nice to feel as a child. it feels good when you can feel your mom is confident in your capacity to find your way.
...
### 2021-05-30 01:12 - (2021-03-20 p1)

#### (43:48) - needing to be right

I've been trying to figure out how to talk about this subject for a few days now, but I'm just going to shoot it out here. I have really been noticing how this new perspective of "follow this mistakes" has really opened up a new thing for me. I don't really like the idea of being right at all anymore. I think I'm pretty wrong on a lot of things. I just fail so miserably as so many things. I don't mean to, but for whatever reason it just keeps getting worse and worse. I feel like it may be bothering some people because I fail on so many things, but for me it's not about right or wrong -- it's about discovery of a new thing.

the best example I can give of this is the difference between 3/6 and 2/5 approach to creating. if all I do is feel something, source puts all the pieces together and then I just discover its properties or listen to the joke myself for the first time, it feels to people like it's not worth it. if I just open up my mouth, then that means I am forever reliant on source for my inspiration and what if source isn't there, right? it feels like if I churn away at the problem and come to my own conclusion without anyone's help, then my effort makes it more "right" than something that's effortless.

it's hard to describe the concept but it feels like I need to work on an idea a lot and put a lot of effort and logic into the idea, then the logic proves the "rightness" of the idea. I don't really like that. I prefer to just sorta "shoot from the hip" see what shows up, then repeat the effort. I like to think of this as creation by rapid prototyping, seeing what works well, what doesn't then make a new one. rinse and repeat until I have something that pleases me.

I'm reminded of a quote of edison I haerd when I was a kid. I can't find it now, but the paraphase that got etched in my mind was something like, "I didn't fail 100 times at making a light; instead, I found 100 ways it won't work" -- something like that. not very inspirational, but I never regarded rightness as the necessity for success. I've always had a negative approach to life, paying most attention to all the stuff that doesn't work. each fail illuminates for me a new aspect of its function. threfore, I like to just try something and then iterate, trying something else, then iterate again. that's what nature does anyway. given enough experiments and tries, a bigger picture begins to emerge for me of what's important. it's hard to convey this idea succinctly, but for me mistakes (or failures) have always guided me much more than the successes have.

perpendicular to that, I would also say that every time I've had a lot of money or some sort of "success", then things went downhill rapidly for me. in order for me to continue to grow and evolve, I need to constantly be under pressure of a looming disaster. I guess I thrive in destruction and chaos. the pressure causes me to focus and gives me the drive to keep going. when things are easy, I slow down and get lazy and sloppy. in that sense, I really like competition. I like pressure to contiually make better and better things. I like critics in that sense that they can identify a flaw or an inconsistency cause it gives me something to think about. give me some time and I can often times come up with something that will perhaps not be the right answer but at least something on the path to it. if not, I just say I don't know or I think maybe it's impssible given the contraints.

I'm probably pretty opposite to how almost everyone else is. I don't claim that I'll ever get it right -- just that given enough time, I'll bounce around the idea enough times ("failing") till I finally figure out the feel of it.
...
I don't really know how to begin this one so I'll just let it go. right before the "uhh" sound, I was thinking about the lyra thing I just wrote which brought me to the next subject in my mind which revolved around the form of perception that girls seem to exhibit. it seems they can project mental objects (colours and shapes) into 3d space with ease. I consider this +5 functionality. I've been trying to learn how to do this myself... I don't know if I can yet, but I do know I can cause people to feel things with my heart (+4) and I can also receive transmissions in my heart (-4) with ease as well. likewise I seem to be able to receive this (-5) with ease, I don't know yet how good I am at transmitting or creating these objects myself (+5). my goal is te get there as I think this is the future of me manifesting different concepts (extensions of myself) into 3d space which people can play with as if they were real physical objects -- like they really are there and have atoms but they were created as a refection of me instead of through some physical process. the important thing is they are a physical manifestion as a reflection of me, which is the (+5)

repeating myself a bit here from a different angle: the new dimension I want to manifest into people's perception is grounded in concept and emotion, meaning it's entirely perceptual. to put it simply, the +5 people around will create the environment in which this reality is perceived. or, to put it another way, because this form of perception transcends the fabric of space-time, anything perceivable can happen really anywhere. I guess it's kind of like a wormhole in that if the conceptual environment (frequency) is the same as it is on another side of the galaxy/universe, then information (time and space) can be passed between these two.

when looking at these things, not physically, but as a vibration, we all share the same sort of conceptual "space" here on earth, but then that space is individual to the person and changes over time.. in that sense, there isn't any distance or time. imagine instead time being perceived as the sequence of transformations that take place to get from one conceptual space to another. like "time", distance can also be perceived as a sequence of vibrational transformations however I can't see it well because it's orthoganal to my perception. if similar things attract (like gravity), dissimilar things create space. vibrational dissimilarity is important because without this separation everything would collapse in on itself. again, I feel like if I keep trying to explain this reality with words, it gets very misunderstood. I need to show you -- or rather it needs to be experienced to explain it satisfactorally.

so here's the subject that I was originally going to write before I got off into the new dimension thing again. I'm so infatuated with the idea, I can't stop thinking of it -- so sorry. it's like I'm in love with it. anyway, anyone creative knows this as standard procedure before sudden genesis which is probably why...

---

relating to this (+5) perception, it feels to me that the prevailing thought is that little girls have this form of perception, then they grow, and after that it's decay, decline, and all things getting uglier and worse after that (something like that it feels like). I can't undertand this. it shouldn't be like this at all. that sounds like a specifically nosebook perspective. my personal experience is that once things get better they continue getting better and better until I interrupt them with my perception with things like, "oh now it has to get worse" or "this can't last forever" -- those types of thoughts.

I believe this universe is pretty perceptually flat is because there really isn't a whole lot of distance between feeling something on the way and feeling anything thing on the way. once basic principals are discovered, anyone can make anything feel better or worse and continue on to feel it getting better and better (or worse and worse). it becomes so easy to feel anything the way you want it, with only a little bit of effort, you can be anything you want to be. there shouldn't be any decline unless you want to feel that (and you reflect it). this means it should/will be be effortless for anyone to feel any age they want to feel or see any way they want to see. you just have to find a way to feel the way you want to feel. you define the conceptual space and it transcends space and time.

uhhh, yeah.

#### (44:11) - further thinking on needing the manifestation

all of what I whote above relates to a monologue I was having the other day about not needing the manifestation. I don't understand why people want me to have a manifestation so much. to me this makes no difference. I just make things. I like making things. if other people derive a lot of pleasure out of my creations, that's great. for me the manifestation isn't the creation, but the creating process.
...
I'm having trouble finding the connecting thought, but I came to the conclusion that mr. motor also doesn't ever get the manifestation because he's not OK with others having it, so he holds himself away from it just to ensure that others aren't getting something good either. this seems only possible to me because others' not having enjoyment appears more important to him than his own.

why not just enjoy the creation process and leave all others out of it? it's the comparison that creates the decay and decline. think of it this way. if you never saw someone getting old and decrepit, you would never believe it was something that happens to everyone. so, if you lived in a world where evewything is a reflection of your perception, you could easily live on and never notice age. it's an imposed perception taught to us by the physical world. however, what if time and distance were perceived as experience and appearance -- the foundation of your perception -- and that *all* things are how you perceive them to be?

I figure it'll be good practise. we'll fight against perceived demons that we (and others) have created with our minds and perceive to be real problems and difficulties. not everyone will see everything in the space though. people only see the stuff they believe is real. the frequency of a demon may appear to me as a delightful person however to you it could be anything -- a creature or even a feeling of loneliness. eventually we'll all find it natural to experience what we want to experience.

this will make all of us extremely naive and childlike because we're living in the good conditions of our perception. we're kind of like children living in the good conditions of proximity to sirius. later though, when we are more distant from sirius again, unless we're creating the space ourselves, we'll "fall" back down into the toil of physicality and see our physical bodies again. I guess we'll have to wait to see what happens :)

I don't think it's a bad thing if we find ourselves back in physicality again. each iteration we're going to become more and more capable of creating that conceptual environment ourselves. I really don't have any idea what'll happen; I just want to explore the limits of what it would be like to live in a place with reduced limits on time and space.

witsout a time limit you can go back and fix your past all you want if that's what you want to do. so you go back in time and change all sorts of things about yourself... and then what? imagine how much time people will spend infinitely fixing things in their past to make their present better. who will be the first to figure out that things are a reflection of their perecption and just perceive how how they wish to see it?

this is the ultimate game *I* want to beat. this new thing is really just the thing I want to create for me. from my perspective, others will be there to help make circumstances as difficult as possible for me to figure out my source perspective with all of the distractions everywhere. finding my way in the midst of difficulty is easy. instead, I find it pretty difficult to master my perception during easy times (times with lots of wanted). so, in this new setting will I still be able to find my way or will I fall into the trap of pleasure-filled laziness? what about the others? how huch good good stuff is too much before I'm ready to go back to decline, decay, and death? (eg. comparing myself to others again to determine what "normal" is)

reactions are telling me that people are seeing this the opposite of how I mean it. when I say distractions, I don't mean annoyint car motor sounds or irritating physical circumstances. I mean the good-feeling distractions that slow a person way down (like pleasure). if I'm really good at feeling good, then I need to balance that out by taking disharmonious portions of me and putting them together (or inverting them) to play the "bad-guy" role in other peoples' reality. however, in order to balance all of those bad-guys, other parts will be living a pretty good-feeling reality. where am I? where is my source? in the middle. neither of these extremes will be easily able to return to the source perspective easily (both need to find a way to harmonise with the source signal -- eg. find a way to feel good about the circumstances).

the versions of me living pain will feel the pain, not the well-being. that's not where my source is. the good-feeling ones will feel the physical conditions and be distracted by so much good stuff. that is neiter where my source is. my source feels even better than that, but because I'm so distracted by the physicasl stuff (like drugs or whatever) I totally miss the point. for me, it's much more difficult to return to that source perspective (of who I really am) in pleasure. rather, I find that difficulty and pain cause me to focus much more effectively. I really do like difficulty, cause that's when I'm most creative and connected. with this, perhaps you can see why my desire is to find a way to go infinitely without the manifestation...
