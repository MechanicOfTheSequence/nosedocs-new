...
### 23° different east-west axial tilt

- karnak temple obelisk shows major heat damage on the bottoms of the obelisks, and they're all 23° off from present east-west, indicating that the planet had a different east-west than the present day east west. @[youtube](https://youtu.be/x1NyhSCq5_s?t=1264)
  - however, because the great pyramid is aligned to the east-west of today, these older parts of karnak must predate the great pyramid, or the great pyramid was designed in such a way to essentially set the new east-west after the cataclysm, and the planet assumed the alignment of the great pyramid.
    - I wonder how many other ancient (pre-dynastic) structures are off from present east-west
  - all of the damage seems to have come from the east, quite possibly at dawn.
    - this could indicate that these temples were built to resonate with the sun and attract its energy, it could have happened that in an already energised moment, attracting more energy could create an overload causing these selective heat damages to these energetic structures.
    - or, it could indicate that the structures were resonating bodies, and they essentially had some sort of life-giving plasma coming out of them -- almost as if the quartz inside of the granite were being vibrated in such a way to create pezioelectricity, ionising the air aruond the the structure.
